	...
	<div class="jumbotron">
		...
		<div align=center class="input-append">
			<form id=simform class=form-inline action="statusadmin.php" method="get">
				...
				<?php echo $MSG_USER?>
				<input class="form-control" type=text size=8 name=user_id value='<?php if (!isset($gid)){echo  htmlspecialchars($user_id, ENT_QUOTES);} ?>'>&nbsp;
...
<script src="template/bs3/auto_refresh.js?v=0.40"></script>
</body>
</html>
