...
<body leftmargin="30">
  <center>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse" width="100%" height="50">
      <tr>
        ...
        <td>
          <p align="center">
            <font color="#333399" size="4">Welcome To Administrator's Page of Judge Online of ACM ICPC,<?php echo $OJ_NAME ?>.</font>
        </td>
        <td width="100"></td>
      </tr>
    </table>
  ...
  <form method=POST action=problem_add.php>
    <p align=center>
      <font size=4 color=#333399>Add a Problem</font>
    </p>
    ...
    <p align=left>Output:<br>
      <!--<textarea rows=13 name=output cols=80></textarea>-->
