              ...
              <table width=100% class='center table table-condensed'>
                ...
                <tbody>
                  ...
                  foreach ($result as $row) {
                    ...
                    echo "<td>" . $row['time'] . "</td>";
                    echo "<td><a href=news_df_change.php?page=$page&id=" . $row['news_id'] . "&getkey=" . end($_SESSION[$OJ_NAME . '_' . 'getkey']) . ">" . ($row['defunct'] == "N" ? "<span class=green>$MSG_ENABLED</span>" : "<span class=red>$MSG_DISABLED</span>") . "</a>" . "</td>";
