...
class config
{
    ...
    function __construct()
    {
        ...
        if ($OJ_LANG == "zh") $this->data['lang'] = "cn";
    }
    function save()
    {
...
function download()
{
    global $current_dir, $filename, $download_ext_filter;
...
{
    global $charset, $fm_color, $setflag;
    echo "
...
{
    global $fm_current_root, $current_dir, $quota_mb, $resolveIDs, $order_dir_list_by, $islinux, $cmd_name, $ip, $path_info, $fm_color, $dir_before;
    $ti = getmicrotime();
    clearstatcache();
    ...
    if ($opdir = @opendir($current_dir)) {
        ...
        $out .= "
            ...
            <input type=button onclick='javascript:window.location.href=\"problem_list.php\"' value='" . et("Back") . "'>
...
{
    global $_FILES, $current_dir, $dir_dest, $fechar, $quota_mb, $path_info, $test_js, $upload_num;
    $num_uploads = 5;
    html_header();
    echo "<body marginwidth=\"0\" marginheight=\"0\">";
    if (count($_FILES) == 0) {
...
function edit_file_form()
{
    ...
    <tr><td colspan=2><textarea name=file_data style='width:640px;height:480px;'>" . html_encode($file_data) . "</textarea></td></tr>
...
{
    global $cfg;
    global $current_dir, $fm_self, $doc_root, $path_info, $fm_current_root, $lang, $error_reporting, $version, $ChkVerWarning;
    ...
    function list_files($list)
    {
        ...
        foreach ($list as $current) {
            ...
            if (strstr($current, "*")) {
                ...
                $files[] = array(
                    'name' => $current, 'name2' => $this->options['prepend'] .
    ...
    function parse_dir($dirname)
    {
        ...
        while ($file = @readdir($dir)) {
            if ($file == "." || $file == "..") {
                ...
                $files[] = array(
                    'name' => $dirname . "/" . $file, 'name2' => $this->options['prepend'] .
...
class zip_file extends archive
{
    ...
    function create_zip()
    {
        ...
        foreach ($this->files as $current) {
            ...
            $translate =  array(
                'Ç' => pack("C", 128), 'ü' => pack("C", 129), 'é' => pack("C", 130), 'â' => pack("C", 131), 'ä' => pack("C", 132),
