              ...
              <table width=100% class='center table table-condensed'>
                ...
                foreach ($result as $row) {
                  ...
                  if (isset($_SESSION[$OJ_NAME . '_' . 'administrator']) || isset($_SESSION[$OJ_NAME . '_' . "m$cid"])) {
                    echo "<td><a href=contest_pr_change.php?page=$page&cid=" . $row['contest_id'] . "&getkey=" . end($_SESSION[$OJ_NAME . '_' . 'getkey']) . ">" . ($row['private'] == "0" ? "<span class=green>$MSG_Public</span>" : "<span class=red>$MSG_Private<span>") . "</a></td>";
                    echo "<td><a href=contest_df_change.php?page=$page&cid=" . $row['contest_id'] . "&getkey=" . end($_SESSION[$OJ_NAME . '_' . 'getkey']) . ">" . ($row['defunct'] == "N" ? "<span class=green>$MSG_ENABLED</span>" : "<span class=red>$MSG_DISABLED</span>") . "</a></td>";
                    ...
                    if (isset($_SESSION[$OJ_NAME . '_' . 'administrator']) || isset($_SESSION[$OJ_NAME . '_' . 'contest_creator'])) {
                      echo "<td><a href=\"problem_export_xml.php?cid=" . $row['contest_id'] . "&getkey=" . end($_SESSION[$OJ_NAME . '_' . 'getkey']) . "\">$MSG_EXPORT</a></td>";
                    } else {
                      echo "<td></td>";
                    }
                    echo "<td> <a href=\"../export_contest_code.php?cid=" . $row['contest_id'] . "&getkey=" . end($_SESSION[$OJ_NAME . '_' . 'getkey']) . "\">$MSG_LOG</a></td>";
                  } else {
