...
///////////////////////////MAIN	
	...
	if (!$result){
		...
		foreach ($category as $cat){
			...
			$view_category.= "<a class='label label-$label_theme' style='display: inline-block; margin-top: 2px; margin-bottom: 2px;' href='problemset.php?search=".(htmlentities($cat,ENT_QUOTES,'UTF-8'))."'>".htmlentities($cat,ENT_QUOTES,'utf-8')."</a>&nbsp;";
