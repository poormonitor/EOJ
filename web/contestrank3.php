 ...
 * @return array
 */
function getProblemMapByCid($cid)
{
...
if (isset($_GET['type']) && $_GET['type'] == 'json') {
    ...
    if (isset($_GET['list']) && $_GET['list'] == 'submit') {
        ...
        $subList = getSubmitByCid($cid);
        $problemMap = getProblemMapByCid($cid);
