...
<div id=footer class='center col-sm-2'><a id='footer' href='https://git.oldmonitor.cn/poormonitor/hustoj'>Modified under GPLv3</a></div>
...
<script src="<?php echo "template/$OJ_TEMPLATE/" ?>index.min.js"></script>
<?php
