        ...
        <div class="jumbotron">
            <div class='faq'>
                <h2 class="ui center aligned header" style="font-size:36px!important;">帮助</h2>
                    ...
                    <strong>在Python中，input中的prompt字段会被输出并被认定为答案的一部分。</strong></p>
                    <br><h2 class="ui header">查重</h2>
                    <p>
                    ...
                    <br><h2 class="ui header">个人资料</h2>
                    <p>我们依据 GB/T 35273-2020 《信息安全技术 个人信息安全规范》存储、使用您的隐私数据。</p>
                    <br><h2 class="ui header">返回结果说明</h2>
                    <div class="ques-view">
                    ...
                    <h3>感谢您选择 Hangzhou High School OJ。</h3>
                </div>
            </div>
        </div>
        <!-- /container -->
