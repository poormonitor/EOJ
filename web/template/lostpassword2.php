      ...
      <center>
        ...
        <form action=lostpassword2.php method=post class='form-horizontal'>
          <div class="form-group">
            ...
            <label class="col-sm-4 control-label" style="text-align: left;"><?php echo $MSG_LOSTPASSWORD_WILLBENEW ?></label>
          </div>
          <div class="form-group">
            <label class="col-sm-4 control-label"><?php echo $MSG_EMAIL ?></label>
            <div class="col-sm-4">
              <input name="lost_key" type="text" class="form-control" required>
            </div>
          </div>
          <div class="form-group">
