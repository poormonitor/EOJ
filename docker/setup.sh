...
mkdir -p /var/log/hoj
mv /trunk /home/judge/hoj
chmod -R 755 /home/judge/etc
chmod -R 755 /home/judge/backup
chmod -R 755 /home/judge/hoj/web/include/
chown -R www-data:www-data /home/judge/data
chown -R www-data:www-data /home/judge/hoj/web

# Judge daemon and client
sh /home/judge/hoj/core/make.sh

# Adjust system configuration
CPU=`grep "cpu cores" /proc/cpuinfo |head -1|awk '{print $4}'`
USERNAME=`cat /etc/mysql/debian.cnf |grep user    |head -1|awk  '{print $3}'`
PASSWORD=`cat /etc/mysql/debian.cnf |grep password|head -1|awk  '{print $3}'`
mv /home/judge/hoj/web/include/db_info.default.php /home/judge/hoj/web/include/db_info.inc.php
cp /home/judge/hoj/install/java0.policy  /home/judge/etc/
cp /home/judge/hoj/install/judge.conf    /home/judge/etc/
cp /home/judge/hoj/install/judged        /etc/init.d/judged
cp /home/judge/hoj/install/default.conf  /etc/nginx/sites-available/default
...
sed -i "s#DB_USER[[:space:]]*=[[:space:]]*\"root\"#DB_USER=\"$USERNAME\"#g"                  /home/judge/hoj/web/include/db_info.inc.php
sed -i "s#DB_PASS[[:space:]]*=[[:space:]]*\"root\"#DB_PASS=\"$PASSWORD\"#g"                  /home/judge/hoj/web/include/db_info.inc.php
