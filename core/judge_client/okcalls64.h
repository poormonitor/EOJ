...
int LANG_YV[CALL_ARRAY_SIZE] = {
    ...
    61, 52, 288, 28, 83, 262, 334, 435, 18,
    SYS_read, SYS_write, SYS_mprotect, SYS_getuid, SYS_getgid, SYS_geteuid, SYS_getegid, SYS_munmap, SYS_brk,
...
// sqlite3
int LANG_SQLV[CALL_ARRAY_SIZE] = {0, 8, 18, 75, 87, 1, 3, 4, 5, 6, 9, 10, 11, 12, 13, 14, 16, 17, 21, 39, 41, 42, 59, 72, 79, 102, 107, 158, 218, 231, 257, 262, 273, 302, 318, 334,
