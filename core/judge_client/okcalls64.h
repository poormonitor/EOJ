 ...
 */
// c & c++
int LANG_CV[CALL_ARRAY_SIZE] = {0, 1, 2, 3, 5, 8, 9, 10, 11, 12, 13, 14, 20, 21, 39, 56, 59, 63, 89, 99, 158, 186, 231, 234, 268, 275, 292, 511,
...
int LANG_YV[CALL_ARRAY_SIZE] = {
    ...
    89, 97, 102, 104, 107, 108, 131, 137, 158, 202, 218, 228, 231, 257, 273, 204, 291, 63, 511, 82, 54, 51, 50, 7, 44, 47,
    SYS_read, SYS_write, SYS_mprotect, SYS_getuid, SYS_getgid, SYS_geteuid, SYS_getegid, SYS_munmap, SYS_brk,
...
int LANG_BASICV[CALL_ARRAY_SIZE] = {
    0, 1, 3, 4, 5, 9, 10, 12, 13, 14, 16, 17, 21, 59, 158, 173, 218, 231, 257, 273, 302, SYS_read, SYS_write, SYS_mprotect, SYS_ptrace, SYS_brk, SYS_setfsuid, SYS_capget, SYS_rt_sigaction,
...
// sqlite3
int LANG_SQLV[CALL_ARRAY_SIZE] = {0, 8, 18, 75, 87, 1, 3, 4, 5, 6, 9, 10, 12, 13, 14, 16, 17, 21, 39, 41, 42, 59, 72, 79, 102, 107, 158, 218, 231, 257, 273, 302,
