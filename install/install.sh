...
git clone https://git.oldmonitor.cn/poormonitor/hoj.git
USER="jol"
...
mv hoj/web/include/db_info.default.php hoj/web/include/db_info.inc.php
cp hoj/install/java0.policy  /home/judge/etc
cp hoj/install/judge.conf  /home/judge/etc
...
sed -i "s/DB_USER[[:space:]]*=[[:space:]]*\"root\"/DB_USER=\"$USER\"/g" hoj/web/include/db_info.inc.php
sed -i "s/DB_PASS[[:space:]]*=[[:space:]]*\"root\"/DB_PASS=\"$PASSWORD\"/g" hoj/web/include/db_info.inc.php
